...
## cd wlan-ap/openwrt && ./scripts/gen_config.py profiles/glinet-axt1800 glinet_depends
cd wlan-ap/openwrt && ./scripts/gen_config.py profiles/glinet-$DEVICE1 glinet_depends
